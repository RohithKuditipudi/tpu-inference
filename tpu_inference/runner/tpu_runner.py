...
# Joint-decode / rerank token-decision callback (Marin overlay). When
# RERANK_TOKEN_DECISION_URL is set, the runner POSTs per-step top-k logits to
# that URL and forces the returned token into the sampler. No-op when unset.
